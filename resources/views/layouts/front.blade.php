...
<body>
  <div class="w-full mx-auto wrapper-fluid overflow-hidden relative flex min-h-screen flex-col">
    ...
    <div class="header absolute top-0 left-0 z-10 w-full  px-4">
      ...
      <!-- off-canvas start -->
      <div id="header-off-canvas" class="overflow-hidden [&.open-canvas]:-translate-x-[14px] w-[100vw] -translate-x-[100%] header-off-canvas absolute z-20 top-0 left-0 h-[100vh] bg-[rgba(0,0,0,0.3)]">
            ...
            <div class="sm-icons w-fit flex justify-between items-center mt-7">
              <a href="{{ $options->where('key', 'instagram')->first()->value }}" class="mr-4 w-[35px] h-[35px] group ">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 30 30" fill="none">
                  ...
                  <path d="M18.4321 15.0178C18.4321 16.9423 16.8925 18.4819 14.968 18.4819C13.0435 18.4819 11.5039 16.9423 11.5039 14.9857C11.5039 13.0933 13.0756 11.5537 15.0001 11.5537C16.8925 11.5537 18.4321 13.0933 18.4321 15.0178ZM14.9359 17.2631C16.1548 17.2631 17.1812 16.2367 17.1812 15.0178C17.1812 13.799 16.1548 12.7726 14.9359 12.7726C13.685 12.7726 12.6907 13.799 12.6907 15.0178C12.6907 16.2367 13.7171 17.2631 14.9359 17.2631Z" fill="white" class="group-hover:fill-orange transition-all duration-[0.1s] ease-linear" />
                  <path d="M19.3625 11.3932C19.3625 11.8422 19.0096 12.2271 18.5606 12.2271C18.1115 12.2271 17.7266 11.8422 17.7587 11.3932C17.7587 10.9441 18.1115 10.5913 18.5606 10.5913C19.0096 10.5913 19.3625 10.9441 19.3625 11.3932Z" fill="white" class="group-hover:fill-orange transition-all duration-[0.1s] ease-linear" />
                </svg>
              </a>
