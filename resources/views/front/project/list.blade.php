        ...
        <div class="body-content h-fit w-full">
         ...
         <a href="{{ route('project', $project->id) }}">
          <div id="project-wrapper" class="project-wrapper flex flex-wrap mt-5 w-full justify-between">
            <div class="project mb-2 md:h-[400px] sm:h-[350px] max-sm:h-[280px] border w-full bg-no-repeat bg-cover bg-center flex flex-wrap items-stretch relative" style="background-image: url({{ asset($project->image) }});">
              <div class="top-text w-full h-fit absolute left-0 top-0 px-5 py-3">
              ...
              <div class="top-bottom w-full h-fit bottom-0 text-orange absolute left-0 px-5 py-3">
                <!-- text is here -->
