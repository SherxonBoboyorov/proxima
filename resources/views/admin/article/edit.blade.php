        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Изменить Новости</h4>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_uz" class="my-editor" id="content_uz" cols="30" rows="10">{{ $article->content_uz }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_ru" class="my-editor" id="content_ru" cols="30" rows="10">{{ $article->content_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_ru" class="form-control" id="meta_title_ru" cols="30" rows="5">{{ $article->meta_title_ru }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_ru" class="form-control" id="meta_description_ru" cols="30" rows="5">{{ $article->meta_description_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_uz" class="form-control" id="meta_title_uz" cols="30" rows="5">{{ $article->meta_title_uz }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_uz" class="form-control" id="meta_description_uz" cols="30" rows="5">{{ $article->meta_description_uz }}</textarea>
