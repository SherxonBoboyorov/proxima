                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="sub_content_uz" class="form-control" id="sub_content_uz" cols="10" rows="4"></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="sub_content_ru" class="form-control" id="sub_content_ru" cols="10" rows="4"></textarea>
                                ...
                                <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                                    <div class="row" style="margin-top: 15px">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="description_uz" class="my-editor" id="description_uz" cols="10" rows="5" style="height: 150px;"></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="description_ru" class="my-editor" id="description_ru" cols="10" rows="5" style="height: 150px;"></textarea>
                                ...
                                <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                    <div class="row" style="margin-top: 15px">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="specifications_ru" class="my-editor" id="specifications_ru" cols="10" rows="5" style="height: 150px;"></textarea>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="price_uz" id="price_uz" class="form-control">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="price_ru" id="price_ru" class="form-control">
                    ...
                    <textarea name="meta_description_uz" id="meta_description_uz" class="form-control" cols="30" rows="5"></textarea>
                    </div>
                    <br>
                    <div class="col-md-6">

                    <label for="meta_description_ru">Meta Description RU</label>
                    <textarea name="meta_description_ru" id="meta_description_ru" class="form-control" cols="30" rows="5"></textarea>
                </div>
            </div>
